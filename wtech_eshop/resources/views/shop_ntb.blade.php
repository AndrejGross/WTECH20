...
<div class="row">
        ...
        <div class="col" id="main">
            ...
            <div class="jumbotron">
                ...
                <a class="btn btn-primary" href="{{ route('shop-ntb-gaming', $id) }}" role="button">Herné NTB</a>
                <a class="btn btn-primary ml-5" href="{{ route('shop-ntb-office', $id) }}" role="button">Kancelárske NTB</a>
            </div>
        </div>
    </div>
    <!-- !BREADCRUMB------------------------------------------------------------------------------------------------------------------------------------- !-->
