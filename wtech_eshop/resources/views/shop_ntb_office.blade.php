...
<div class="row">
        ...
        <div class="col" id="main">
            ...
            <div class="jumbotron">
                <h1 class="">Kancelárske notebooky</h1>
                <hr class="">
            ...
            <div class="row">
                <div class="col text-center">
                    ...
                    <label class="float-right">
                        ...
                        <button class="btn btn-primary" onclick="window.location='{{ route('shop-ntb-office', [$id, 'sort' => 'high_low']) }}'" >Najdrahšie</button>
                        <button class="btn btn-primary" onclick="window.location='{{ route('shop-ntb-office', [$id, 'sort' => 'low_high']) }}'" >Najlacnejšie</button>
                    </label>
                </div>
            ...
            <div class="row">
                <nav class="col-6 bg-secondary collapse" id="sidebar">
                        <section>
                            ...
                            <form method="GET" action="{{ route('shop-ntb-office', $id)}}">
                                @csrf
                                <section class="">
